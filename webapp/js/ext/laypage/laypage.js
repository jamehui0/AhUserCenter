...
//分页视图
    Page.prototype.view = function(){
        ...
        //当前页非首页，则输出上一页
        (conf.curr > 1 && conf.prev)?
            view.push('<a href="javascript:;" class="laypage_prev" data-page="'+ (conf.curr - 1) +'">'+ conf.prev +'</a>'):
            view.push('<a href="javascript:;" class="laypage_prev" style="visibility: hidden" data-page="'+ (conf.curr - 1) +'">'+ conf.prev +'</a>');
        //当前组非首组，则输出首页
        if(dict.index > 1 && conf.first && conf.groups !== 0)view.push('<a href="javascript:;" class="laypage_first" data-page="1"  title="&#x9996;&#x9875;">'+ conf.first +'</a><span>&#x2026;</span>');
        //输出当前页组
        ...
        if(dict.end - dict.start < conf.groups - 1)dict.start = dict.end - conf.groups + 1; //最后一组状态
        ...
        (conf.curr !== conf.pages && conf.next || dict.flow)?
            view.push((function(){
            ...
            view.push((function(){
                return (dict.flow && conf.curr === conf.pages)
                    ? '<span class="page_nomore" title="&#x5DF2;&#x6CA1;&#x6709;&#x66F4;&#x591A;">'+ conf.next +'</span>'
                    : '<a href="javascript:;" class="laypage_next" style="visibility: hidden" data-page="'+ (conf.curr + 1) +'">'+ conf.next +'</a>';
            }()));
